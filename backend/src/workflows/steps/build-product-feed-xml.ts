    ...
    const itemsXml = input.items.map((item) => {
      return (
        `<item>` +
          ...
          `<g:identifier_exists>${escape(item.identifier_exists)}</g:identifier_exists>` +
          ...
          (item.shipping_weight ? `<g:shipping_weight>${escape(item.shipping_weight)}</g:shipping_weight>` : "") +
          (item.shipping_length ? `<g:shipping_length>${escape(item.shipping_length)}</g:shipping_length>` : "") +
          (item.shipping_width ? `<g:shipping_width>${escape(item.shipping_width)}</g:shipping_width>` : "") +
          (item.shipping_height ? `<g:shipping_height>${escape(item.shipping_height)}</g:shipping_height>` : "") +
        `</item>`
      )
    }).join("")
