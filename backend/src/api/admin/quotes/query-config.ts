export const quoteFields = [
  ...
  "*customer",
  "*messages",
  // cart.metadata carries submit-time fields (po_number, attn_to,
  // notes) so the admin quote-detail page can render them; the
  // draft_order copies addresses at creation time but expanding the
  // cart's canonical view keeps a single source of truth.
  "cart.id",
  "cart.metadata",
