...
posthog.init('${POSTHOG_KEY}',{api_host:'${POSTHOG_API_HOST}',ui_host:'${POSTHOG_UI_HOST}',capture_pageview:'history_change',person_profiles:'identified_only',disable_surveys:true});`}
        </Script>
      )}
    </>
  )
