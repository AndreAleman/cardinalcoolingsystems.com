...
export const metadata: Metadata = {
  ...
  description:
    "Terms and conditions for using our website and purchasing our premium stainless steel sanitary fittings.",
}
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2>2. Use License</h2>
        <p>
          Permission is granted to view the material on Cardinal Cooling
          Systems&apos;s web site for informational purposes only. This is the
        ...
        <ul>
          ...
          <li>
            ...
            Cardinal Cooling Systems&apos;s web site;
          </li>
          <li>
        ...
        <p>
          ...
          restrictions and may be terminated by Cardinal Cooling Systems at any
        ...
        <h2>3. Disclaimer</h2>
        <p>
          The materials on Cardinal Cooling Systems&apos;s web site are provided
          &quot;as is&quot;. Cardinal Cooling Systems makes no warranties,
          expressed or implied, and hereby disclaims and negates all other
          warranties, including without limitation, implied warranties or
          conditions of merchantability, fitness for a particular purpose, or
          non-infringement of intellectual property or other violation of
          rights. Further, Cardinal Cooling Systems does not warrant or make any
        ...
        <h2>4. Limitations</h2>
        <p>
          In no event shall Cardinal Cooling Systems or its suppliers be liable
          ...
          use or inability to use the materials on Cardinal Cooling Systems&apos;s
          Internet site, even if Cardinal Cooling Systems or a Cardinal Cooling
          Systems authorized representative has been notified orally or in
        ...
        <p>
          The materials appearing on Cardinal Cooling Systems&apos;s web site
          could include technical, typographical, or photographic errors.
          Cardinal Cooling Systems does not warrant that any of the materials on
          its web site are accurate, complete, or current. Cardinal Cooling
          Systems may make changes to the materials contained on its web site at
          any time without notice. Cardinal Cooling Systems does not, however,
          make any commitment to update the materials.
        </p>

        <h2>6. Links</h2>
        <p>
          Cardinal Cooling Systems has not reviewed all of the sites linked to
          ...
          by Cardinal Cooling Systems of the site. Use of any such linked web
          site is at the user&apos;s own risk.
        </p>

        <h2>7. Site Terms of Use Modifications</h2>
        <p>
          Cardinal Cooling Systems may revise these terms of use for its web
        ...
        <p>
          Any claim relating to Cardinal Cooling Systems&apos;s web site shall
